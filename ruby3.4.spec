...
Provides: ruby(abi) = 3.4.0
Provides: ruby(runtime_executable) = 3.4
Provides: ruby-default = %{epoch}:%{version}-%{release}
Provides: ruby3.4-stdlib = %{epoch}:%{version}-%{release}
Provides: ruby34 = %{epoch}:%{version}-%{release}
Conflicts: ruby-default < %{epoch}:%{version}-%{release}
Conflicts: ruby3.4-stdlib < %{epoch}:%{version}-%{release}
Conflicts: ruby34 < %{epoch}:%{version}-%{release}
Obsoletes: ruby-default < %{epoch}:%{version}-%{release}
Obsoletes: ruby3.4-stdlib < %{epoch}:%{version}-%{release}
Obsoletes: ruby34 < %{epoch}:%{version}-%{release}
...
%package -n ruby3.4-libs
Summary: Libraries necessary to run Ruby
Requires: ruby3.4 = %{epoch}:%{version}-%{release}
Provides: ruby(release) = 3.4

%description -n ruby3.4-libs
This package is a dependency package, which depends on default Ruby
version (currently v3.4).

%package -n ruby3.4-doc
Summary: Documentation for Ruby 3.4

%description -n ruby3.4-doc
This package contains the autogenerated documentation for Ruby 3.4.

%package -n ruby3.4-devel
Summary: Header files for compiling extension modules for Ruby (default version)
Requires: ruby3.4 = %{epoch}:%{version}-%{release}
Requires: ruby3.4-libs = %{epoch}:%{version}-%{release}

%description -n ruby3.4-devel
This package is a dependency package, which depends on default Ruby
version (currently v3.4).
...
%package -n ruby3.4-rubygem-bundler
Summary: Manage Ruby application dependencies (runtime)
Requires: rubygem-bundler = %{epoch}:%{version}-%{release}

%description -n ruby3.4-rubygem-bundler
Bundler manages a Ruby application's dependencies through its entire
life, across many machines, systematically and repeatably.
...
%post -n ruby3.4-libs -p /sbin/ldconfig
%postun -n ruby3.4-libs -p /sbin/ldconfig
...
%files -n ruby3.4-rubygem-bundler
%license COPYING
