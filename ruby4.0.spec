...
Provides: ruby(abi) = 4.0.0
Provides: ruby(runtime_executable) = 4.0
Provides: ruby-default = %{epoch}:%{version}-%{release}
Provides: ruby4.0-stdlib = %{epoch}:%{version}-%{release}
Provides: ruby40 = %{epoch}:%{version}-%{release}
Conflicts: ruby-default < %{epoch}:%{version}-%{release}
Conflicts: ruby4.0-stdlib < %{epoch}:%{version}-%{release}
Conflicts: ruby40 < %{epoch}:%{version}-%{release}
Obsoletes: ruby-default < %{epoch}:%{version}-%{release}
Obsoletes: ruby4.0-stdlib < %{epoch}:%{version}-%{release}
Obsoletes: ruby40 < %{epoch}:%{version}-%{release}
...
%package -n ruby4.0-libs
Summary: Libraries necessary to run Ruby
Requires: ruby4.0 = %{epoch}:%{version}-%{release}
Provides: ruby(release) = 4.0

%description -n ruby4.0-libs
This package is a dependency package, which depends on default Ruby
version (currently v4.0).

%package -n ruby4.0-doc
Summary: Documentation for Ruby 4.0

%description -n ruby4.0-doc
This package contains the autogenerated documentation for Ruby 4.0.

%package -n ruby4.0-devel
Summary: Header files for compiling extension modules for Ruby (default version)
Requires: ruby4.0 = %{epoch}:%{version}-%{release}
Requires: ruby4.0-libs = %{epoch}:%{version}-%{release}

%description -n ruby4.0-devel
This package is a dependency package, which depends on default Ruby
version (currently v4.0).
...
%package -n ruby4.0-rubygem-bundler
Summary: Manage Ruby application dependencies (runtime)
Requires: rubygem-bundler = %{epoch}:%{version}-%{release}

%description -n ruby4.0-rubygem-bundler
Bundler manages a Ruby application's dependencies through its entire
life, across many machines, systematically and repeatably.
...
%post -n ruby4.0-libs -p /sbin/ldconfig
%postun -n ruby4.0-libs -p /sbin/ldconfig
...
%files -n ruby4.0-rubygem-bundler
%license COPYING
